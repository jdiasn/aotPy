...
from aotConf import outputTempDataPath as tempOutpuPath
...
print 'Extracting %s data, month %s from %s' % (sensor, month, str(size))
#---------------------------------
...
#--------------------------------------
	for station in range(len(nameStationAux)):
		...
		tempFile = tempOutpuPath+'/tempData_'+sensor+'_'+resolution+'_'+nameStationAux[station]+'_'+year+'_'+str(time)+'_aotArr40.p'
		pickle.dump(aotArr40[station], open(tempFile, 'wb'))

		tempFile = tempOutpuPath+'/tempData_'+sensor+'_'+resolution+'_'+nameStationAux[station]+'_'+year+'_'+str(time)+'_latArr40.p'
		pickle.dump(latArr40[station], open(tempFile, 'wb'))

		tempFile = tempOutpuPath+'/tempData_'+sensor+'_'+resolution+'_'+nameStationAux[station]+'_'+year+'_'+str(time)+'_lonArr40.p'
...
tempFile = tempOutpuPath+'/tempData_'+sensor+'_'+resolution+'_'+year+'_'+month+'_timeArr.p'
