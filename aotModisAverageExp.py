...
aotFileList = getFileBetween2Days(beginDay, beginDay, aotFileList)
...
print(Fore.RED + 'Extraction %s data finished,day %s month %s from %s' % (satellite, day, month, str(size)))
